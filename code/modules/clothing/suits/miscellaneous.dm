...
/obj/item/clothing/suit/keithsweatshirt
	name = "Keith Sweatshirt"
	desc = "Don't get it Twisted, Something Just Ain't Right with this shirt, it's guaranteed to Make You Sweat."
	icon_state = "keithsweatshirt"
	item_state = "keithsweatshirt"
	mutantrace_variation = STYLE_DIGITIGRADE|STYLE_NO_ANTHRO_ICON
